...
public class FavOtelSayfa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_otel_sayfa);

        ref = FirebaseDatabase.getInstance().getReference().child("Kategoriler").child("Oteller");

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Oteller").orderByChild("yerpuan").startAt(4);
