...
public class FavOtoparkSayfa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_otopark_sayfa);

        ref = FirebaseDatabase.getInstance().getReference().child("Kategoriler").child("Otoparklar");

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Otoparklar").orderByChild("yerpuan").startAt(4);
