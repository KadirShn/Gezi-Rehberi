...
public class FavTarihiyerlerSayfa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_tarihiyerler_sayfa);

        ref = FirebaseDatabase.getInstance().getReference().child("Kategoriler").child("Tarihiyerler");

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Tarihiyerler").orderByChild("yerpuan").startAt(4);
