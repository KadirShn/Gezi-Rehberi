...
public class FavKutuphaneSayfa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_kutuphane_sayfa);

        ref = FirebaseDatabase.getInstance().getReference().child("Kategoriler").child("Kutuphaneler");

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Kutuphaneler").orderByChild("yerpuan").startAt(4);
