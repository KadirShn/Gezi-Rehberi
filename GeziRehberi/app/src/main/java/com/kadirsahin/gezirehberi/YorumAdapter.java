...
public class YorumAdapter extends RecyclerView.Adapter<YorumAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.eleman_yorum, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        viewHolder.isimYorum.setText(mComment.get(i).getKullaniciad());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            isimYorum = itemView.findViewById(R.id.yorumklc);
            yorumAlani = itemView.findViewById(R.id.yorumtxt);
        }
    }
}