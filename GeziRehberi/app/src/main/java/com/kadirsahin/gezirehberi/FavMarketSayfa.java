...
public class FavMarketSayfa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_market_sayfa);

        ref = FirebaseDatabase.getInstance().getReference().child("Kategoriler").child("Marketler");

        Query query = FirebaseDatabase.getInstance().getReference("Kategoriler").child("Marketler").orderByChild("yerpuan").startAt(4);
